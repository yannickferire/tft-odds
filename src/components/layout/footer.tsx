      ...
      <div className="flex flex-col sm:flex-row px-4 justify-between gap-4 sm:gap-16 md:gap-32">
        ...
        <div className="order-1 sm:order-2 flex-1 flex">
          ...
          <p className="flex-1 text-center sm:text-right text-xs text-crema leading-5">
            ...
            <span className="opacity-40">Made by</span> <a className="leading-[30px] sm:leading-normal font-bold opacity-40 hover:opacity-100" href="https://lolchess.gg/profile/euw/krksyx" target="_blank" rel="noopener noreferrer"><Image className="inline-block -mt-px" width="20" height="20" src="/images/ranks/master.webp" alt="Rank: Master" /> krksyx</a><span className="inline opacity-40"> – © 2023 TFT Odds</span></p>
        </div>
      </div>
    </footer>
    <Script id="axeptio">

      ...
      <div className="flex flex-col sm:flex-row px-4 justify-between gap-4 sm:gap-8 md:gap-16">
        ...
        <div className="order-1 sm:order-2 flex-1 flex">
          ...
          <ul className="flex-1 text-center sm:text-right text-xs text-crema leading-5">
            ...
            <li>
              <a href="https://tactics.tools/player/euw/tftodds%20com" className="leading-[30px] sm:leading-normal opacity-40 hover:opacity-100 tracking-wider font-bold"><Image className="inline-block -mt-1" width="20" height="20" src="/images/ranks/diamond.webp" alt="Rank: Diamon" /> tftodds com</a>
            </li>
            <li>

...
import RollingOdds from "./rollingOdds";
...
const ChampionSelector: React.FC<IChampionSelector> = ({ champs, setChamps, isLoading, selectedLevel }) => {
    ...
    <div className="flex flex-col rounded w-100 overflow-hidden">
      <header 
        ...
        <div className="hidden md:flex gap-1 absolute top-1/2 -translate-y-1/2 right-4">
          <RollingOdds selectedLevel={selectedLevel} />
        </div>
      </header>
      {isLoading === false ? (

...
const badgeVariants = cva(
  'inline-flex items-center whitespace-nowrap justify-center border border-neutral-200 border-transparent font-medium focus:outline-hidden focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0 dark:border-neutral-800 dark:focus:ring-neutral-300',
  {
    variants: {
      variant: {
        primary: 'bg-neutral-900 text-neutral-50 dark:bg-neutral-50 dark:text-neutral-900',
        ...
        outline: 'bg-transparent border border-neutral-200 text-neutral-900 dark:border-neutral-800 dark:text-neutral-50',
    ...
    compoundVariants: [
      ...
      },
      {
        variant: 'secondary',
        appearance: 'light',
        className: 'bg-neutral-100 dark:bg-neutral-100/50 text-neutral-900 dark:bg-neutral-800 dark:dark:bg-neutral-800/50 dark:text-neutral-50',
      },
      {
        variant: 'success',
        appearance: 'light',

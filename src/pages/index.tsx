  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Teamfight Tactics Odds – TFT Set 11 probabilities tools" />
        ...
        <meta name="twitter:title" content="Teamfight Tactics Odds – TFT Set 11 probabilities tools" />

  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Teamfight Tactics Odds – TFT Set 8.5 probabilities calculators" />
        ...
        <meta name="twitter:title" content="Teamfight Tactics Odds – TFT Set 8.5 probabilities calculators" />

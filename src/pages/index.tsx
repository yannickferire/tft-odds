...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Teamfight Tactics Odds – TFT Set 8.5 probabilities tools</title>
        ...
        <meta property="og:title" content="Teamfight Tactics Odds – TFT Set 8.5 probabilities tools" />
        ...
        <meta name="twitter:title" content="Teamfight Tactics Odds – TFT Set 8.5 probabilities tools" />

  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:description" content="Comprehensive augments distribution rules cheatsheet. Will your final augment be a prismatic one? Find out now! Good luck and may your Augments lead you to victory!" />

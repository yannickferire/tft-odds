...
const ChemBaron: NextPage = () => {
  ...
  return (
    <>
      ...
      <h1 className="text-3xl mt-4 mb-4 font-bold px-4 text-center"><strong className="text-morning">Chem Baron</strong> loot tables</h1>
      <ul className="mb-4 flex gap-2 justify-center">
        {champs.filter((champion) => champion.traits.includes("Chem-Baron")).map((champion, index) => (
          <li 
          key={index} 
